...
outdir = "/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/accusleep/models/balanced/";
...
writetable(T, strcat(outdir,'mytable_weights.csv'));
save(strcat(outdir,'predictions_f1_weights.mat'), 'all_pred')
