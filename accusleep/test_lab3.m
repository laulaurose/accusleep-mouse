...
%outdir = '/zhome/dd/4/109414/Validationstudy/accusleep_v4/labdata/models/all_n/balanced/lab3/';
...
%load ~/Validationstudy/accusleep_v4/labdata/models/all_n/balanced/lab3/best_model_epoch_5.mat
...
save(strcat(outdir,'kornum_labels.mat'),'all_labels')
save(strcat(outdir,'kornum_preds.mat'),'all_pred')
save(strcat(outdir,'kornum_labs.mat'),'all_labs')
