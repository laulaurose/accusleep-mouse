...
%outdir = '/zhome/dd/4/109414/Validationstudy/accusleep_v4/labdata/models/all_n/balanced/lab5/';
outdir = '/zhome/dd/4/109414/Validationstudy/accusleep_v4/accusleep/models/new/orig/';
load /zhome/dd/4/109414/Validationstudy/accusleep_v4/labdata/fileList_test_Sebastian.mat
%load ~/Validationstudy/accusleep_v4/labdata/models/all_n/balanced/lab5/best_model_epoch_8.mat
...
save(strcat(outdir,'Seb_labels.mat'),'all_labels')
save(strcat(outdir,'Seb_preds.mat'),'all_pred')
save(strcat(outdir,'Seb_labs.mat'),'all_labs')
