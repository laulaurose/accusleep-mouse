...
imageLocation = '/work3/laurose/accusleep/data/prep/training_images_2024-01-24_15-59-14/';
%imageLocation = '/work3/laurose/accusleep/data/prep_balanced/training_images_2024-01-20_14-04-12/'
[net,info] = AccuSleep_train_org(fileList, SR, epochLen, epochs,imageLocation); 
save('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/accusleep/models/balanced/net_f1_weights.mat', 'net');

load fileList_test.mat
%load /Users/qgf169/Documents/MATLAB/AccuSleep/models/accusleep_org/imbalanced/net.mat
%load /zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/accusleep/models/imbalanced/net.mat
...
writetable(T, 'mytable_weights.csv');
save('predictions_f1_weights.mat', 'all_pred')
save('labels.mat','all_labels')
