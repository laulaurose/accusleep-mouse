...
% CheckpointPath  = '/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/';
% modeltype_     = "lab"; 
% isWCE_         = 1;
% fold           = '1';
% w_vec          = [2,3,4,5];
% [net,trainInfo]= train_dlnetwork(imdsTrain,imdsValidation,CheckpointPath,modeltype_,isWCE_,fold,w_vec); 
% save('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/net.mat', 'net');
outdir = '/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/';
load fileList_test_Alessandro.mat
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/checkpoint_epoch_1.mat','net')
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/checkpoint_epoch_1.mat','bestF1Score')
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab1/checkpoint_epoch_1.mat','patience')
disp(bestF1Score)
disp(patience)
