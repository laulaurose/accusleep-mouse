...
% imageLocation5 = '/work3/laurose/accusleep/data/labSebastian/training_images_2024-01-25_16-04-36/';
% 
...
% train_1 = allFiles1(randomIndices1(1:floor(subsetSize1*0.8)));
% train_2 = allFiles2(randomIndices2(1:floor(subsetSize2*0.8)));
% train_3 = allFiles3(randomIndices3(1:floor(subsetSize3*0.8)));
% train_4 = allFiles4(randomIndices4(1:floor(subsetSize4*0.8)));
% 
% val_1   = allFiles1(randomIndices1(floor(subsetSize1*0.8)+1:end));
% val_2   = allFiles2(randomIndices2(floor(subsetSize2*0.8)+1:end));
% val_3   = allFiles3(randomIndices3(floor(subsetSize3*0.8)+1:end));
% val_4   = allFiles4(randomIndices4(floor(subsetSize4*0.8)+1:end));
% 
% imdsTrain1      = imageDatastore(train_1, 'Labels', imds1.Labels(randomIndices1(1:floor(subsetSize1*0.8))));
% imdsTrain2      = imageDatastore(train_2, 'Labels', imds2.Labels(randomIndices2(1:floor(subsetSize2*0.8))));
% imdsTrain3      = imageDatastore(train_3, 'Labels', imds3.Labels(randomIndices3(1:floor(subsetSize3*0.8))));
% imdsTrain4      = imageDatastore(train_4, 'Labels', imds4.Labels(randomIndices4(1:floor(subsetSize4*0.8))));
% 
% imdsVal1        = imageDatastore(val_1, 'Labels', imds1.Labels(randomIndices1(floor(subsetSize1*0.8)+1:end)));
% imdsVal2        = imageDatastore(val_2, 'Labels', imds2.Labels(randomIndices2(floor(subsetSize2*0.8)+1:end)));
% imdsVal3        = imageDatastore(val_3, 'Labels', imds3.Labels(randomIndices3(floor(subsetSize3*0.8)+1:end)));
% imdsVal4        = imageDatastore(val_4, 'Labels', imds4.Labels(randomIndices4(floor(subsetSize4*0.8)+1:end)));
% 
% 
...
% CheckpointPath  = '/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/';
% modeltype_     = "lab"; 
% isWCE_         = 1;
% fold           = '3'
% w_vec          = [1,2,4,5]
% [net,trainInfo]= train_dlnetwork(imdsTrain,imdsValidation,CheckpointPath,modeltype_,isWCE_,fold,w_vec); 
% 
%save('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/net.mat', 'net');
outdir = '/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/';
load fileList_test_Kornum.mat
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/checkpoint_epoch_1.mat','net')
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/checkpoint_epoch_1.mat','bestF1Score')
load('/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/models/all_n/balanced/lab3/checkpoint_epoch_1.mat','patience')
disp(bestF1Score)
disp(patience)
