...
for j = 1:length(exps) % loops across experts     
    disp(testsets{j})
    load(testsets{j})
    count_w = 0; 
    count_n = 0; 
    ...
    counts(j,:) = [count_w,count_n,count_r];

end 

save("/zhome/dd/4/109414/Validationstudy/accusleep_v2/AccuSleep/labdata/counts.mat",'counts')
